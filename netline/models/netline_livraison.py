    ...
    def create_invoice(self):
        ...
        for l in nll:
            ...
            if len(l.reception_line_id.product_id) >0:
                cps_facturation_lines.append({ 'product_id': l.reception_line_id.product_id.product_id.id, 'product_name': l.reception_line_id.product_id.name, 'product_description' : l.reception_line_id.product_id.name, 'sequence': i, 'qty_to_invoice': l.to_deliver_quantity, 'quantity_livre': l.to_deliver_quantity, 'reste_a_facturer': l.to_deliver_quantity, 'price' : l.reception_line_id.product_id.prix_lavage})
            if len(l.reception_line_id.product_pressing_id) >0:
                cps_facturation_lines.append({ 'product_id': l.reception_line_id.product_pressing_id.product_id.id, 'product_name': l.reception_line_id.product_pressing_id.name,  'product_description' : l.reception_line_id.product_pressing_id.name, 'sequence': i, 'qty_to_invoice': l.to_deliver_quantity, 'quantity_livre': l.to_deliver_quantity, 'reste_a_facturer': l.to_deliver_quantity, 'price' : l.reception_line_id.product_pressing_id.prix_lavage})
